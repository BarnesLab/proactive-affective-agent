...
The agentic advantage is not driven by outlier participants. Examining per-user mean BA across all binary targets, V4 outperforms V1 for 10 of 11 participants (mean per-user BA: V4 = 0.693 $\pm$ 0.070 vs.\ V1 = 0.541 $\pm$ 0.037). Similarly, V6 outperforms V3 for 10 of 11 participants (V6 = 0.696 $\pm$ 0.065 vs.\ V3 = 0.631 $\pm$ 0.056). The single participant (User 310) where the agentic advantage is smallest also has the lowest NA base rate (4.9\% elevated), leaving little room for binary state detection. The consistency of the agentic advantage across participants with diverse base rates and sensing coverage patterns suggests the improvement is genuine rather than a sampling artifact.
