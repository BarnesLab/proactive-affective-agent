...
CALLM$^\ddagger$ & Diary + RAG & 3.661 & 0.624 & 0.611 \\
V1$^\ddagger$ & Sensing & 5.502 & 0.523 & 0.465 \\
V2 & Sensing & 4.881 & 0.601 & 0.594 \\
V3$^\S$ & Multimodal & \textbf{3.947} & 0.638 & 0.632 \\
V4 & Multimodal & 4.353 & 0.666 & 0.660 \\
V6 & Multimodal & 4.220 & \textbf{0.669} & \textbf{0.663} \\
\addlinespace
...
\bottomrule
\multicolumn{5}{l}{\small $^\ddagger$13/18 users; $^\S$10/18 users. \todo{Results for CALLM/V1/V3 will update when all users complete.}} \\
\end{tabular}
\end{table}
...
\midrule
CALLM$^\ddagger$ & 0.678 & 0.697 & 0.531 & 0.521 & 1.572 \\
V1$^\ddagger$ & 0.533 & 0.518 & 0.494 & 0.396 & 2.802 \\
V2 & 0.669 & 0.672 & 0.733 & 0.732 & 1.316 \\
V3$^\S$ & 0.734 & 0.751 & 0.565 & 0.561 & 1.740 \\
...
\bottomrule
\multicolumn{6}{l}{\small $^\ddagger$13/18 users; $^\S$10/18 users---interim results.} \\
\end{tabular}
\end{table}
...
\midrule
CALLM$^\ddagger$ & 0.566 & 0.545 & 0.681 & 0.700 & 5.147 & \textbf{4.264} \\
V1$^\ddagger$ & 0.522 & 0.406 & 0.520 & 0.510 & 7.033 & 6.671 \\
V2 & 0.604 & 0.603 & 0.633 & 0.609 & 6.023 & 7.304 \\
V3$^\S$ & 0.601 & 0.580 & 0.727 & 0.740 & 5.899 & 4.201 \\
...
\bottomrule
\multicolumn{7}{l}{\small $^\ddagger$13/18 users; $^\S$10/18 users---interim results.} \\
\end{tabular}
\end{table}
...
\toprule
\textbf{Target} & \textbf{CALLM}$^\ddagger$ & \textbf{V1}$^\ddagger$ & \textbf{V2} & \textbf{V3}$^\S$ & \textbf{V4} & \textbf{V6} \\
\midrule
