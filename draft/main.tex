...
V1$^\ddagger$ & Sensing & 0.521 & 0.453 \\
V2 & Sensing & 0.598 & 0.591 \\
V3$^\S$ & Multimodal & 0.607 & 0.590 \\
V4 & Multimodal & 0.666 & 0.661 \\
V6 & Multimodal & \textbf{0.669} & \textbf{0.664} \\
\addlinespace
...
\bottomrule
\multicolumn{4}{l}{\small $^\ddagger$13/18 users; $^\S$10/18 users. \todo{Results for CALLM/V1/V3 will update when all users complete.}} \\
\end{tabular}
\end{table}
