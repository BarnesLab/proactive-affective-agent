...
Table~\ref{tab:main_results} and Figure~\ref{fig:ba_comparison} present aggregate results across all prediction targets. The agentic multimodal variants (V4, V6) achieve the highest overall balanced accuracy and F1.
