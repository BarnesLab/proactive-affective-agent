...
The ranking is clear: agentic multimodal (V4/V6) $>$ structured multimodal (V3) $>$ CALLM $>$ agentic sensing (V2) $>$ text baselines $>$ structured sensing (V1) $>$ ML sensing baselines. The agentic multimodal agents (V6: BA=0.669, V4: BA=0.666) substantially outperform all non-LLM baselines (best: MiniLM BA=0.629).
