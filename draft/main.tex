...
We evaluate all agent variants on a pilot subset of 11 cancer survivors drawn from the BUCS test sets: participants 43, 71, 119, 164, 258, 275, 310, 338, 403, 458, and 513. These participants span 5 cross-validation folds, yielding 956 EMA entries per agent variant (7 variants $\times$ 956 = 6,692 total predictions). Each participant contributes 81--93 chronologically ordered EMA entries, evaluated sequentially to simulate real-time deployment.
